...
const MAP_DATA = {
  ...
  'Britney': {
    ...
    walls: [
      ...
      { x: 900, y: 380, w: 20, h: 540 }, { x: 400, y: 900, w: 210, h: 20 }, { x: 690, y: 900, w: 210, h: 20 },
      { x: 400, y: 650, w: 500, h: 20 },
      
      // PULSE-WING (NE) — Roof: 2100, 400, 500, 500
      { x: 2080, y: 380, w: 20, h: 540 }, { x: 2100, y: 380, w: 500, h: 20 },
      { x: 2600, y: 380, w: 20, h: 540 }, { x: 2100, y: 900, w: 210, h: 20 }, { x: 2390, y: 900, w: 210, h: 20 },
      { x: 2100, y: 650, w: 500, h: 20 },
      
      // CENTRAL-HUB (Center) — Roof: 1200, 1200, 600, 600
      { x: 1180, y: 1180, w: 20, h: 640 }, { x: 1800, y: 1180, w: 20, h: 640 },
      { x: 1200, y: 1180, w: 260, h: 20 }, { x: 1540, y: 1180, w: 260, h: 20 },
      { x: 1200, y: 1800, w: 260, h: 20 }, { x: 1540, y: 1800, w: 260, h: 20 },
